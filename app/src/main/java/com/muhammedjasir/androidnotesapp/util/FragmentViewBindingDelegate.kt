package com.muhammedjasir.androidnotesapp.util
...
class FragmentViewBindingDelegate<T :ViewBinding>(
    ...
    override fun getValue(thisRef: Fragment, property: KProperty<*>): T {
        ...
        val view = thisRef.view
            ?: throw IllegalStateException("Should not attempt to get bindings when fragment view is null.")
...
): FragmentViewBindingDelegate<T> = FragmentViewBindingDelegate(this,{ v -> viewBindingFactory(v)}, cleanUp)
